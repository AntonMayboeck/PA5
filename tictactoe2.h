...
public:
	...
	toetactic() { Play(); }//default constructor that calls the main menu function
	...
	void boardchoice(int c) //this function takes the choice and matches it to the proper board box
	{
		switch (c)
		{
		case 1:
